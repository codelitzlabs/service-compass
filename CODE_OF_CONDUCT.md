...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the community leaders at `opensource@codelitz.com`.

> **Maintainer verification required:** confirm that `opensource@codelitz.com` is monitored before publication.
